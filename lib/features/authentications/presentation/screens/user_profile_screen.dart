...
// import 'package:office_application/features/authentications/presentation/screens/allUsers_screen.dart';
...
//   final user = UserModel(id: '', name: 'name', role: userRole.Admin);
//   @override
...
//               ),
//               child: ProfileTile(icon: Icons.person_2_outlined, title: 'Users'),
//             ),
//             // GestureDetector(
//             //   onTap: () => Authservices().deleteUser(),
//             //   child: ProfileTile(
//             //     icon: Icons.logout,
//             //     title: 'Logout',
//             //     color: Colors.red,
